...
const PAGES = [
  ...
  },
  {
    ...
    note: '归魂币不会重置关卡奖励；续战重新使用预设装备，不复制旧远征的极强构筑。',
  },
  {
    label: '辨认异化',
    title: '看见颜色，读懂破绽',
    ...
    points: [
      ...
      [
        '王会再次起身',
        '困难与长夜中的灰烬之王有第二条命。首领登场必须看完3秒；灰烬之王每次登场为4秒，期间战斗暂停。',
      ],
    ],
    note: '多王与连战有独立血条和阶段提示。第一条血清空，并不一定意味着这一战结束。',
  },
  {
    label: '登神长阶',
    title: '白翼折断，神性归尘',
    ...
    points: [
      [
        '天使化',
        '白翼带来减伤与恢复。首次击败后会复生，进入10秒无敌狂暴；此时集中精力躲避。',
      ],
      [
        '破碎之后',
        '时间短暂停滞、神性破碎，翅膀消失并出现红色受创闪烁。原有天使庇护已消失，此时全力进攻。',
      ],
      [
        '最后一场演出',
        '第99关迎战两条命的登神之王，第100关直面主神。主神按演出阶段承受伤害，不能被瞬间击败；观察预兆，耐心走完。',
      ],
    ],
    note: '百关胜利即完成正式结算；第101关只有馈赠与祝福，最后的署名出现后，远征正式结束。',
  },
] as const;
