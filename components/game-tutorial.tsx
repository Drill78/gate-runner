...
function BuildDiagram() {
  return (
    <Diagram label="击杀获得金币和经验，兵装秘匣提升武器。骑士的三选一示例是初始护盾、护盾增伤和过门补盾，围绕已有构筑选择。">
...
function BossDiagram() {
  return (
    <Diagram label="首领顶部显示大血条。队伍移出红色攻击预警，同时持续输出；章节首领的周期全屏压力无法通过走位躲避。">
...
const PAGES = [
  ...
  },
  {
    ...
    points: [
      ...
      [
        '先取钥印，再挑战禁术',
        '取得禁术钥印后，下一次精英先过 5 道全宽必经红门，再争夺极窄平方 x² 门；旁边可选 √x 或加法。本局只开启一次。',
      ],
    ],
  ...
  },
  {
    ...
    points: [
      [
        '盯住首领大血条',
        '普通、精英关底与章节 Boss 都要击败。移出红区，穿过弹隙。',
      ],
      [
        '留技能应对关键招式',
        '灰烬之王吟唱时，集中输出或用技能打断，避免全屏伤害。',
      ],
      [
        '章节压力检验 DPS',
        '章节 Boss 交战一段时间后，会周期性造成越来越强的全屏伤害，走位躲不掉。',
      ],
    ],
