...
export const ENCOUNTERS: EncounterProfile[] = [
  ...
  },
  {
    ...
    kind: 'boss',
    description:
      '破碎王冠重铸为焚誓之铠。焚誓巡礼将道路依次点燃，灰烬残碑提供护佑；敕令留有安全区，结束后产生镜像余震。双翼焚风与逆行陨火要求持续变换站位。',
  },
  {
    id: 'king-ascendant',
    name: '登神·灰烬之王',
    ...
    hint: '日冕会依次合拢 · 留意明暗圣痕 · 沿光隙斩断王权',
    color: '#ffe5aa',
    kind: 'boss',
    description:
      '日冕、圣枪与破晓敕令编织着窃来的神域。王冠下的暗火追随旧誓，圣轨在两侧祭坛之间折转；认清圣痕的先后，不要在敕令结束时停下脚步。',
  },
  {
    id: 'deity',
    name: '主神·无名的黎明',
    ...
    kind: 'boss',
    description:
      '横跨天穹的主神以创世光柱、星河、圣约与六翼合奏回应来者。万象之弦牵动星海，天平摇转，织路的光柱追逐晨星；寂静钟声之后，终曲将破除最后的迷雾。圣约护持着这场会面，每一次审判都留下宽阔生路。',
  },
];
